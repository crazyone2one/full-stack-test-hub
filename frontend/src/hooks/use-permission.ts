...
import {hasAnyPermission, topLevelMenuHasPermission} from "/@/utils/permissions.ts";
...
export default function usePermission() {
    ...
    return {
        ...
        accessRouter(route: RouteLocationNormalized | RouteRecordRaw) {
            ...
            return (route.meta?.requiresAuth === false || !roles || roles.includes('*') || hasAnyPermission(roles || []));
        },
